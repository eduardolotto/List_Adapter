...
public class TestRunner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nTest of ListAdapter..");
        res = JUnitCore.runClasses(TestBasicModOp.class, TestBulkOp.class, TestEquals.class,
                TestGet.class, TestHIterator.class, TestHListIterator.class, TestModList.class);
        esitoTest(res);
